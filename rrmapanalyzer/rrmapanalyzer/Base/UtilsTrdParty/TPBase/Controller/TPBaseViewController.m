...
- (TPBarButtonItem *)leftBackItem {
    if (!_leftBackItem) {
        _leftBackItem = [TPBarButtonItem backItemWithoutTitle:self action:@selector(backButtonTap)];
    }
...
- (TPBarButtonItem *)leftCancelItem {
    if (!_leftCancelItem) {
        _leftCancelItem = [TPBarButtonItem cancelItem:self action:@selector(CancelButtonTap)];
    }
