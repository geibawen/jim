...
- (void)layoutSubviews {
    ...
    float rightContentInsets = 1;
    
    if (_rightImage) {
        UIButton *rightButton = [[UIButton alloc] initWithFrame:CGRectMake(self.width - 24, 0, 24, self.height)];
        ...
        [rightButton addTarget:self action:@selector(rightItemTap:) forControlEvents:UIControlEventTouchDown];
//        rightButton.imageView.right = 24;
